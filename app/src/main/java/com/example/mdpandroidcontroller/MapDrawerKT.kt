...
import com.example.mdpandroidcontroller.entity.Map
import com.example.mdpandroidcontroller.entity.Robot


@Suppress("unused")
class MapDrawerKT(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
